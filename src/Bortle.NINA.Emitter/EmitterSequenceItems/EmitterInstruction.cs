using Bortle.NINA.Emitter.Properties;
...
namespace Bortle.NINA.Emitter.EmitterTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "Emitter")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class EmitterInstruction : SequenceItem {
        /// <summary>
        ...
        public EmitterInstruction(EmitterInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new EmitterInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(EmitterInstruction)}, Text: {Text}";
        }
    }
}