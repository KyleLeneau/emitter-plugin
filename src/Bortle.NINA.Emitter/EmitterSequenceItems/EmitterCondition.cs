...
namespace Bortle.NINA.Emitter.EmitterTestCategory {
    ...
    public class EmitterCondition : SequenceCondition {
        /// <summary>
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(EmitterCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}