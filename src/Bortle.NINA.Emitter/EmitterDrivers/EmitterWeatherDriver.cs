...
namespace Bortle.NINA.Emitter.EmitterDrivers {
    /// <summary>
    ...
    /// </summary>
    public class EmitterWeatherDriver : BaseINPC, IWeatherData {
        public EmitterWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"Emitter Weather Data ({deviceId})";
        ...
        public string Category => "Emitter Weather Driver";
