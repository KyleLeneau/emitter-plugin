...
namespace Bortle.NINA.Emitter.EmitterDrivers {
    ...
    public class EmitterWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public EmitterWeatherProvider(IProfileService profileService) {
        ...
        public IList<IWeatherData> GetEquipment() {
            ...
            devices.Add(new EmitterWeatherDriver("MyUniqueId", "MyDeviceId"));
