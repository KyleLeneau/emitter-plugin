...
namespace Bortle.NINA.Emitter.EmitterDockables {
    /// <summary>
    ...
    public class EmitterDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public EmitterDockable(
            ...
            dict.Source = new Uri("Bortle.NINA.Emitter;component/EmitterDockables/EmitterDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Bortle.NINA.Emitter_AltitudeSVG"];
